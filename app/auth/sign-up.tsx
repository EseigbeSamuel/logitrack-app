    ...
    >
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: theme.text }]}>REQUEST CLEARANCE</Text>
          <Text style={[styles.subtitle, { color: theme.muted }]}>Register new operator credentials for LogiTrack access.</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: theme.primary }]}>OPERATOR DESIGNATION (NAME)</Text>
            <TextInput
          ...
          <Pressable style={[styles.submitButton, { backgroundColor: theme.primary }]} onPress={handleSignUp}>
            <IconSymbol name="chevron.right" size={20} color={theme.primaryText} />
            <Text style={[styles.submitButtonText, { color: theme.primaryText }]}>CREATE PROFILE</Text>
          </Pressable>
        </View>
      </View>
    </KeyboardAvoidingView>
